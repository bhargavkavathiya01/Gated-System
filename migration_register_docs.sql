-- ============================================================
-- Migration: Add AadharCard + ElectricityBill to register (sp_api_usermaster Op 2)
-- Run in pgAdmin
-- ============================================================
-- tblusermaster already has aadharcard and electricitybill columns
-- (added in migration_approval_datetime.sql).
-- This updates sp_api_usermaster Op 2 to insert them on registration.
-- ============================================================

-- In sp_api_usermaster Operation 2 (INSERT), find the INSERT statement and:
--
-- Add to the column list:
--   aadharcard, electricitybill
--
-- Add to the VALUES list:
--   p_json::json->>'aadharcard',
--   p_json::json->>'electricitybill'
--
-- Full updated INSERT for Op 2:

-- INSERT INTO public.tblusermaster (
--     firstname, middlename, lastname, email, phone,
--     password, password_salt, isactive, createdby, createdon,
--     registertypeid, profileimage,
--     aadharcard, electricitybill               -- ADD THESE TWO
-- )
-- VALUES (
...
--     p_json::json->>'aadharcard',               -- ADD THIS
--     p_json::json->>'electricitybill'            -- ADD THIS
-- )

-- ============================================================
-- OR run this full CREATE OR REPLACE directly:
-- ============================================================
